...
api_version = "v3"
api_key="AIzaSyCc7eswgty1jKjnCTtDsdH78RRdB_1yF0A"

youtube = googleapiclient.discovery.build(api_service_name, api_version, developerKey=api_key)

#Function to fetch the data from MYSQL Database
def fetch_data(query):
    mydb = mysql.connector.connect(host="localhost", user="root", password="Hello@papa12345", database="youtube_data")
...
def fetch_channel_data(newchannel_id):
    try:
        ...
        #Analysing response and extracting the data
            data = {
...
#Function to fetch video ID using channel ID
...
#Function to fetch video datas from the video_IDs
